		...
		<div class="modal-content">
			<form on:submit|preventDefault={saveSettings}>
				...
				<section class="settings-section">
					...
					<div class="form-group checkbox-group">
						<label class="checkbox-label">
							<input type="checkbox" bind:checked={localSettings.enableSmoothing} />
						...
						<div class="preset-buttons">
							{#each canvasPresets as preset}
								<button
									type="button"
									class="preset-btn"
									class:active={localCanvasSettings.width === preset.width &&
										localCanvasSettings.height === preset.height}
				...
				<section class="settings-section">
					...
					<div class="form-group checkbox-group">
						<label class="checkbox-label">
							<input type="checkbox" bind:checked={localSettings.enableAudio} />
							<span class="checkmark"></span>
