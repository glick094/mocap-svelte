						...
						if (holistic && poseTrackingActive && !mediaPipeInitInProgress && videoElement) {
							try {
								...
								if (
									...
									sendErr.message.includes('NetworkError')
								) {
...
<div class="webcam-container">
	...
	<div class="participant-section">
		...
		<div class="participant-input-group">
			...
			<button
				...
				disabled={gameActive}
				title={gameActive
					? 'Cannot scan QR code while game is active'
					: 'Scan QR code for participant info'}
			>
				📷 QR
			</button>
		</div>
	...
	<div class="video-container" style="display: {isLoading || error ? 'none' : 'block'}">
		<video bind:this={videoElement} style="display: none;" playsinline muted autoplay>
			<track kind="captions" src="" label="No captions available" default />
		</video>

		<canvas bind:this={canvasElement} class="output-canvas" {width} {height}></canvas>
	</div>
				...
				<div class="game-score">
					...
					<div class="progress-display">
						...
						<span class="progress-value">
							{gameModeProgress.completed}/{gameModeProgress.total === Infinity
								? '∞'
								: gameModeProgress.total}
							...
							<div class="chart-bar">
								<div
									...
									style="width: {getBarWidth(
										scoreBreakdown.hand
									)}%; background-color: {$gameColors.hand};"
								></div>
							</div>
						</div>
						...
						<div class="chart-item">
							...
							<div class="chart-bar">
								<div
									...
									style="width: {getBarWidth(
										scoreBreakdown.head
									)}%; background-color: {$gameColors.head};"
								></div>
							</div>
						</div>
						...
						<div class="chart-item">
							...
							<div class="chart-bar">
								<div
									...
									style="width: {getBarWidth(
										scoreBreakdown.knee
									)}%; background-color: {$gameColors.knee};"
								></div>
							</div>
						</div>
					</div>
