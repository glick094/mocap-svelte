...
<div class="control-panel">
    ...
    <div class="control-group">
      ...
      <div class="preset-buttons">
        {#each canvasPresets as preset}
          <button 
            class="preset-btn"
            class:active={canvasSettings.width === preset.width && canvasSettings.height === preset.height}
  ...
  <div class="control-section">
    ...
    <div class="button-group vertical">
      <button class="control-btn secondary" on:click={takeScreenshot}>
        📸 Screenshot
      </button>
      
      <button class="control-btn secondary" on:click={resetCanvas}>
        🔄 Reset Canvas
      </button>
      
      <button class="control-btn secondary" on:click={openSettings}>
        ⚙️ Settings
      </button>
    </div>
  </div>
