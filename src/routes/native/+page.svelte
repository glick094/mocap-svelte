<script lang="ts">
  ...
  function toggleGame() {
    ...
    if (isFlowMode) {
      ...
      if (isGameActive && webcamNativeComponent) {
        webcamNativeComponent.startGame();
      } else if (!isGameActive && webcamNativeComponent) {
...
<div class="app-container">
  ...
  <header class="app-header">
    <h1>Play2Move <span class="version-badge">Native</span></h1>
