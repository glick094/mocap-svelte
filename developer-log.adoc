...
* [ ] the flow mode is not showing hands after centering
* [ ] the flow mode is not showing head trials (shows hands)
* [ ] the flow mode is not showing random trials
* [ ] add a visual circle timer in short delay
